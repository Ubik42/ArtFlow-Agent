...
$script = Join-Path $repository "integrations\unreal\import_baked_surface_candidate.py"
...
$arguments = @(
    $project,
    "-unattended", "-nop4", "-nosplash", "-NoSound", "-NoCrashDialog", "-nocrashreports",
    "-ExecutePythonScript=$script", "-abslog=$resolvedLog"
)
