...
OUTPUT_ROOT = ROOT / "artifacts/goal/m52-s1-live-mechanism-rig"
...
def main() -> int:
    ...
    if first.json()["scene_dcc_work"] != repeated.json()["scene_dcc_work"]:
        raise RuntimeError("repeated mechanism dispatch changed the registered work")
    ...
    if work["status"] != "succeeded" or len(work["definition"]["capability_ids"]) != 18:
        raise RuntimeError(f"mechanism work stopped at {work['status']}: {work['message']}")
    ...
    result = {
        "schema_id": "artflow-live-mechanism-rig-work-receipt/1",
        "run_id": RUN_ID,
        ...
        "mechanism_rig_request_sha256": work["definition"]["mechanism_rig_request_sha256"],
        "blender_mechanism_rig_receipt_sha256": work["definition"][
            "blender_mechanism_rig_receipt_sha256"
        ],
        "mechanism_manifest_sha256": work["definition"]["mechanism_manifest_sha256"],
        "mechanism_fbx_sha256": work["definition"]["mechanism_fbx_sha256"],
        "unreal_mechanism_rig_receipt_sha256": work["definition"][
            "unreal_mechanism_rig_receipt_sha256"
        ],
    ...
    (OUTPUT_ROOT / "live-mechanism-rig-work-receipt.json").write_text(
